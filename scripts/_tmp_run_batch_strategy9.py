"""Full 50-coin backtest for New Batch 5 Strategy 9 (all 8 combinations)."""
import sys
import os
import json
...
def main():
    ...
    with open("data/checkpoints/_strategy9_ids.json") as f:
        ids = json.load(f)
    ...
    for variant, sid in ids.items():
        ...
        with open("data/checkpoints/_strategy9_batch_ids.json", "w", encoding="utf-8") as f:

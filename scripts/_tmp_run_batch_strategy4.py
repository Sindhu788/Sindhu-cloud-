"""Full 50-coin backtest for New Batch 5 Strategy 4 (all 3 TP variants)."""
import sys
import os
import json
...
def main():
    ...
    ids = {"structure": "df643d86c987", "fixed_2": "5a26c66ffa42", "fixed_3": "54c9f3b67aa6"}
    ...
    with open("data/checkpoints/_strategy4_batch_ids.json", "w", encoding="utf-8") as f:

"""Full 50-coin backtest for New Batch 5 Strategy 7 (both variants)."""
import sys
import os
import json
...
def main():
    ...
    ids = {"loose": "2f6ff7755c8f", "strict": "eba4cc77ee31"}
    ...
    with open("data/checkpoints/_strategy7_batch_ids.json", "w", encoding="utf-8") as f:
